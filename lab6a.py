...
class Student:
    ...
    def displayGPA(self):
        ...
        except ZeroDivisionError: # For cases such as no courses taken, gpa 0 can be acceptable, and try-except method can be valid
    ...
    def displayCourses(self):
        not_zero = []
        for course in self.courses.keys():
            if self.courses[course] > 0: # Same for loop from above and addGrade def can be used to get courses with grade > 0
                not_zero.append(course)
